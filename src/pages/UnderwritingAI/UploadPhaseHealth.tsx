...
export default function UploadPhaseHealth({
    selectedFiles,
    setSelectedFiles,
    setPhase,
}) {
        ...
        >
            ...
            <div className="flex justify-center items-center gap-10 w-full max-w-6xl">
                ...
                <motion.div
                    ...
                    className={`relative w-80 p-4 rounded-xl border-2 border-dashed transition-all flex flex-col items-center justify-center ${allFilesSelected
